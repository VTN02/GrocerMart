...
import {
    Dashboard, People, Inventory, SwapHoriz, CreditCard,
    AccountBalance, Receipt, LocalShipping, ShoppingCart
...
export default function Layout() {
    ...
    const menuItems = [
        ...
        { text: 'Cheques', icon: <AccountBalance />, path: '/cheques', roles: ['ADMIN'] },
